...
#include "MovieSceneActorVisibilityTrack.generated.h"

class UMovieSceneSection;

UCLASS(Blueprintable)
class DIALOGUESYSTEM_API UMovieSceneActorVisibilityTrack : public UMovieSceneNameableTrack, public IMovieSceneTrackTemplateProducer {
    GENERATED_BODY()
public:
...
public:
    UMovieSceneActorVisibilityTrack();
