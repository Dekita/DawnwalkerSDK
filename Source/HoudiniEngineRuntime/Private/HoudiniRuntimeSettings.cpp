...
UHoudiniRuntimeSettings::UHoudiniRuntimeSettings() {
    ...
    this->NumSessions = 1;
    this->ServerHost = TEXT("172.16.100.106");
    this->ServerPort = 9090;
    this->ServerPipeName = TEXT("hapi");
    this->SharedMemoryBufferSize = 500;
    this->bSharedMemoryBufferCyclic = true;
    ...
    this->bEnableDeprecatedInstanceVariations = false;
    ...
    this->SurfaceDistanceOffset = 0.00f;
