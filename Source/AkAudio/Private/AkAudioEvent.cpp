...
int32 UAkAudioEvent::ExecuteActionOnGameObject(const AkActionOnEventType ActionType, const UAkGameObject* GameObject, const int32 PlayingID, const int32 TransitionDuration, const EAkCurveInterpolation FadeCurve) {
    return 0;
}
