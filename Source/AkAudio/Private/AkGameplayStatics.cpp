...
UAkComponent* UAkGameplayStatics::SpawnAkComponentAtLocation(UObject* WorldContextObject, UAkAudioEvent* AkEvent, FVector Location, FRotator orientation, bool AutoPost, bool AutoDestroy) {
    return NULL;
}
...
void UAkGameplayStatics::SetMaxDiffractionPaths(int32 InMaxDiffractionPaths, UAkGameObject* InGameObject) {
}
...
void UAkGameplayStatics::ResetRTPCValue(UAkRtpc* RTPCValue, int32 InterpolationTimeMs, AActor* Actor) {
}
...
void UAkGameplayStatics::PostTrigger(UAkTrigger* TriggerValue, AActor* Actor) {
}
...
int32 UAkGameplayStatics::PostAndWaitForEndOfEvent(UAkAudioEvent* AkEvent, AActor* Actor, FLatentActionInfo LatentInfo, bool bStopWhenAttachedToDestroyed) {
    return 0;
}
...
void UAkGameplayStatics::GetRTPCValue(UAkRtpc* RTPCValue, int32 PlayingID, ERTPCValueType InputValueType, float& Value, ERTPCValueType& OutputValueType, AActor* Actor) {
}
