...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    int32 ExecuteActionOnGameObject(const AkActionOnEventType ActionType, const UAkGameObject* GameObject, const int32 PlayingID, const int32 TransitionDuration, const EAkCurveInterpolation FadeCurve);
