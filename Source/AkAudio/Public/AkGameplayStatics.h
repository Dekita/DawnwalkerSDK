...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic, meta=(WorldContext="WorldContextObject"))
    static UAkComponent* SpawnAkComponentAtLocation(UObject* WorldContextObject, UAkAudioEvent* AkEvent, FVector Location, FRotator orientation, bool AutoPost, bool AutoDestroy);
    ...
    UFUNCTION(BlueprintCallable)
    static void SetSmoothingConstant(float InSmoothingConstantMs, UAkGameObject* InGameObject);
    ...
    UFUNCTION(BlueprintCallable)
    static void SetMaxDiffractionPaths(int32 InMaxDiffractionPaths, UAkGameObject* InGameObject);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void ResetRTPCValue(UAkRtpc* RTPCValue, int32 InterpolationTimeMs, AActor* Actor);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void PostTrigger(UAkTrigger* TriggerValue, AActor* Actor);
    ...
    static int32 PostAndWaitForEndOfEvent(UAkAudioEvent* AkEvent, AActor* Actor, FLatentActionInfo LatentInfo, bool bStopWhenAttachedToDestroyed);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void GetRTPCValue(UAkRtpc* RTPCValue, int32 PlayingID, ERTPCValueType InputValueType, float& Value, ERTPCValueType& OutputValueType, AActor* Actor);
