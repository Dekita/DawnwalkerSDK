...
struct FMovieSceneActorVisibilityTriggerTemplate : public FMovieSceneActorVisibilityTemplateBase {
    GENERATED_BODY()
public:
    ...
    DIALOGUESYSTEM_API FMovieSceneActorVisibilityTriggerTemplate();
};
